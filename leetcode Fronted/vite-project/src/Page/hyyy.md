...
export default function Homepage({ onSearch = () => {} }) {
  ...
  // Filters state - सारे filter options यहाँ store हैं
...
console.log(problems);
  // Search handler function - यह onSearch prop को call करेगा
  const handleSearch = (e) => {
    ...
    // Parent component (ProblemSearchContainer) को search value pass करो
  ...
  useEffect(() => {
    const fetchProblems = async () => {
      try {
        ...
        // Calculate stats - easy, medium, hard problems count करो
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4">
              {/* Desktop Search Bar - यही search bar onSearch prop को trigger करेगा */}
              <div className="hidden md:block relative">
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleSearch} // handleSearch function use करो
          ...
          {/* Mobile Search Bar - यह भी onSearch prop को trigger करेगा */}
